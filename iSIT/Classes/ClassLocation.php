...
class Location
{
	...
	{
		return "'ID'".$separator."'ADDR'".$separator."'POPIS'".$separator."'AKTIVNI'".$separator."'NAME'";
	}
	...
	public function __construct($array = false)
	{
		...
		die("Location->__construct(\$array=false): Nespravny vstupni prarametr \$array!");
	}
	...
	public function to_array()
	{
		...
		$array[Link::get_name_index()] = $this->name;
		return $array;
	}
	...
	public function is_valid($true=true, $false=false)
	{
    	...
    	if(!Test::is_text($this->name,15))
    	{
			$return = $false;
			$this->name_err = "Parametr \"Name\" musí být vyplněn a má omezenou délku na 15 znaků.";
    	}
    	...
    	if(!Test::is_text($this->addr,100))
    	{
      		$return = $false;
			$this->addr_err = "Parametr \"Addr\" musí být vyplněn a má omezenou délku na 100 znaků.";
		}

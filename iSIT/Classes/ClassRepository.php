...
// *******************
  ...
  {
    $sql = "SELECT id, model, seriove_cislo, aktivni, datum_porizeni, evidencni_cislo, ip, _mac, location, name FROM printers";
  ...
  {
    $sql = "SELECT id, model, seriove_cislo, aktivni, datum_porizeni, evidencni_cislo, ip, _mac, location, name FROM printers WHERE evidencni_cislo LIKE '500%'";
  ...
  {
    $sql = "SELECT id, model, seriove_cislo, aktivni, datum_porizeni, evidencni_cislo, ip, _mac, location, name FROM printers WHERE evidencni_cislo LIKE '400%'";
  ...
  {
    $sql = "SELECT id, model, seriove_cislo, aktivni, datum_porizeni, evidencni_cislo, ip, _mac, location, name FROM printers WHERE evidencni_cislo LIKE '100%' OR evidencni_cislo LIKE '150%'";
  ...
  {
    $sql = "SELECT id, model, seriove_cislo, aktivni, datum_porizeni, evidencni_cislo, ip, _mac, location, name FROM printers WHERE evidencni_cislo NOT LIKE '100%' AND evidencni_cislo NOT LIKE '150%' AND evidencni_cislo NOT LIKE '400%' AND evidencni_cislo NOT LIKE '500%'";
  ...
  {
    $sql = "SELECT id, model, seriove_cislo, aktivni, datum_porizeni, evidencni_cislo, ip, _mac, location, name FROM printers WHERE id = $id";
